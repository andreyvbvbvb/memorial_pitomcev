...
export default function MyPets3DView({
  ...
  const infoAsideClass = isPortraitLayout
    ? "absolute bottom-[calc(4.25rem+env(safe-area-inset-bottom))] left-2 right-2 z-20 h-[min(56dvh,32rem)] overflow-y-auto rounded-[20px] border-2 border-white bg-[#f7f1ee]/95 p-2 shadow-[0_18px_44px_-24px_rgba(0,0,0,0.3)] backdrop-blur"
      ...
      {selectedItem ? (
        <aside className={infoAsideClass}>
          ...
          <div className={infoCardClass}>
            ...
            <div className={isPortraitLayout ? "mt-2 min-h-[9rem] max-h-[18rem] shrink-0 overflow-y-auto rounded-[16px] bg-[#f7f1ee]/70 px-3 py-2" : "mt-4 min-h-0 flex-1 overflow-y-auto rounded-[20px] bg-[#f7f1ee]/70 px-4 py-3"}>
