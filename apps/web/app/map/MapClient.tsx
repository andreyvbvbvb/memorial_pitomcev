  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden bg-slate-50">
      ...
      <div className="relative z-10 flex h-full flex-col gap-4 p-6 pointer-events-none">
        <div className="grid items-start gap-4 lg:grid-cols-[minmax(280px,360px)_minmax(320px,380px)] pointer-events-auto">
          <div className="self-start rounded-3xl border border-slate-200 bg-white/85 p-5 shadow-sm backdrop-blur">
          ...
          <div className="flex max-h-[70vh] flex-col self-start rounded-3xl border border-slate-200 bg-white/85 p-5 shadow-sm backdrop-blur">
